...
Welcome to the sequential documentation suite for the **AI Image Studio & Admin Platform**. Follow these documents in order (00 through 09) to understand, build, containerize, provision, deploy, and monitor the application.

---

## 🔢 Sequential Execution & Implementation Order

| Step | Document | Focus & Target Audience |
| :--- | :--- | :--- |
| **00** | **[00-AZURE_BEGINNERS_GUIDE.md](00-AZURE_BEGINNERS_GUIDE.md)** | **Fresher & Beginner Azure Cloud & DevOps Primer (Plain English + Analogies)** |
...
1. **New to Azure / Cloud?**: Start with **[00-AZURE_BEGINNERS_GUIDE.md](00-AZURE_BEGINNERS_GUIDE.md)**.
2. Read **[02-ARCHITECTURE.md](02-ARCHITECTURE.md)** to understand the dual-app structure and database schema.
3. Review **[03-API_DOCUMENTATION.md](03-API_DOCUMENTATION.md)** for endpoint details.
4. Test locally using **[04-DOCKER_GUIDE.md](04-DOCKER_GUIDE.md)** (`npm run docker:up`).
5. Follow **[05-AZURE_DEPLOYMENT_GUIDE.md](05-AZURE_DEPLOYMENT_GUIDE.md)** & **[06-TERRAFORM_IAC_GUIDE.md](06-TERRAFORM_IAC_GUIDE.md)** to provision Azure resources and deploy to Azure Cloud.
6. Deploy to AKS or Kubernetes using **[07-HELM_KUBERNETES_GUIDE.md](07-HELM_KUBERNETES_GUIDE.md)** and automate with **[08-GITOPS_ARGOCD_GUIDE.md](08-GITOPS_ARGOCD_GUIDE.md)**.
7. Monitor health & performance using **[09-MONITORING_OBSERVABILITY_GUIDE.md](09-MONITORING_OBSERVABILITY_GUIDE.md)**.
